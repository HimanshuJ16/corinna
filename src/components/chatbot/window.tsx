...
export const BotWindow = forwardRef<HTMLDivElement, Props>(
  (
    ...
    console.log(errors)
    return (
      <div className="h-[65vh] w-[50vh] flex flex-col bg-white rounded-xl mr-[80px] border-[1px] overflow-hidden">
        ...
        >
          <TabsContent value="chat">
            ...
            <div className="flex flex-col h-full">
              <div
                ...
                className="px-3 flex h-[34vh] flex-col py-5 gap-3 chat-window overflow-y-auto"
                ref={ref}
              >
                {chats.map((chat, key) => (
                  <Bubble
          ...
          <TabsContent value="helpdesk">
            <div className="h-[44vh] overflow-y-auto overflow-x-hidden p-4 flex flex-col gap-4">
              <div>
